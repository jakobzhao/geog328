...
-   **Lab 3:** [Asynchronous GeoJSON data loading and visualization](labs/lab03) `Due by Sunday, July 9, 23:59 pm PST`
    > If you have taken my Geog 495 in Autumn 2022, please skip Lab 3. However, you still need to submit a thinkpiece on how ChatGPT could assist you in finishing this lab assignment. In the meantime, you need to finish another lab assignment on [Lab 2a: TBD](labs/lab02a) in two weeks. Students who have not taken my Autumn 2022's Geog 495 do not need to work on Lab 2a. `Due by Sunday, July 16, 23:59 pm PST`
