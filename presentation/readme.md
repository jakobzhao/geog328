...
| BA1   | [Add custom markers in Mapbox GL JS](https://docs.mapbox.com/help/tutorials/custom-markers-gl-js/) | Also give example(s) of how to create icons by using online tools                                                          | WK6 (11/10)       |
