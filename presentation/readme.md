...
1. A brief introduction of the feature/example being presented
2. How this feature/example could be applied to real-life projects/scenarios
...
3. The overall structure and the logic flow of the code
4. Code parts that you think need extra attention when programming
5. A working example written by yourself that you would showcase to your classmates
